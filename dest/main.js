...
$(window).scroll(function () {
    ...
    if (scroll > $('.header_1').height()) {
        $('.header_2').css({ "position": "fixed", "top": "0", "background-color": "#ffde00", "height": "80px" });
        $('.header_2 .line').css("display", "none");
    }
    else {
        $('.header_2 .line').css("display", "");
        $('.header_2').css({ "position": "", "top": "", "background-color": "" });
    }
});
